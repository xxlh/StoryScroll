...
import { Container, Graphics, TextStyle, Text, Application, Sprite, Texture, Loader, AnimatedSprite } from 'pixi.js';
...
function () {
  ...
  function StoryScroll(o) {
    ...
    _defineProperty(this, "_windowResize", function () {
      _this.deviceOrientation = _this._getDeviceOrientation();
      _this.deviceWidth = _this.deviceOrientation == 'portrait' ? _this._clientWidth : _this._clientHeight;
      _this.deviceHeight = _this.deviceOrientation == 'portrait' ? _this._clientHeight : _this._clientWidth;
      _this._scalePrev = _this._scale;
      _this._scale = _this.deviceWidth / _this.designWidth;
      _this.maxScroll = _this.designLength - _this.deviceHeight;
      _this.contentWidth = _this.deviceWidth;
      _this.contentLength = _this.designLength * _this._scale;
      _this.viewWidth = _this.designWidth;
      _this.viewLength = _this.deviceHeight / _this._scale;

      _this._setContainerRotation(_this.containerFitWindow, _this.designOrientation, _this.deviceOrientation, _this.deviceWidth);

      _this.containerFitWindow.scale.set(_this._scale, _this._scale);

      _this.app.renderer.resize(_this._clientWidth, _this._clientHeight);

      var scrollerContentWidth = _this.deviceOrientation == 'portrait' ? _this.deviceWidth : _this.contentLength;
      var scrollerContentHeight = _this.deviceOrientation == 'portrait' ? _this.contentLength : _this.deviceWidth;
      var scrollerLeft = _this.deviceOrientation == 'portrait' ? 0 : _this.scrollPosition / _this._scalePrev * _this._scale || 0;
      var scrollerTop = _this.deviceOrientation !== 'portrait' ? 0 : _this.scrollPosition / _this._scalePrev * _this._scale || 0;
      setTimeout(function () {
        _this.scroller.setDimensions(_this._clientWidth, _this._clientHeight, scrollerContentWidth, scrollerContentHeight);

        _this.scroller.scrollTo(scrollerLeft, scrollerTop, false);
      }, 200);
    });
  ...
  _createClass(StoryScroll, [{
    ...
    value: function _scrollerCallback(left, top, zoom) {
      ...
      this.scrollDirection == 'y' ? this.containerScroll.y = -this.storyPosition : this.containerScroll.x = -this.storyPosition; // Run Actions
    ...
    value: function _createContainer(o) {
      ...
      this.app = new Application({
        width: this._clientWidth * devicePixelRatio,
        height: this._clientHeight * devicePixelRatio,
      ...
      this.loader.on("complete", function (loader) {
        return _this4.useLoader = false;
      });
    ...
    key: "_getCommonProps",
    value: function _getCommonProps(obj, props) {
      var commonProps = {};
    ...
    value: function _createAnimatedSprite(imgsrcs, autoPlay) {
      ...
      if (_typeof(imgsrcs) == 'object' && imgsrcs.length > 0) {
        if (!this.useLoader) {
          ...
          imgsrcs.forEach(function (imgsrc) {
            if (!_this5.loader.resources[imgsrc]) _this5.loader.add(imgsrc);
          });
          this.loader.on("complete", function (loader) {
            imgsrcs.forEach(function (imgsrc) {
    ...
    value: function _setActions(obj) {
      ...
      obj.actionByStep = function (props, section, triggerPosition) {
        return _this6.actionByStep(obj, props, section, triggerPosition);
      };

      obj.setPin = function (triggerPosition, section) {
        return _this6.setPin(obj, triggerPosition, section);
      };
    }
  }, {
    ...
    value: function _setChapterChildren(chapter) {
      ...
      chapter.sprite = function (imgsrc, o) {
        return _this7.sprite(imgsrc, o, chapter);
      };

      chapter.spriteAnimated = function (imgsrcs, o, autoPlay) {
        return _this7.spriteAnimated(imgsrcs, o, autoPlay, chapter);
      };

      chapter.graphic = function (o) {
        return _this7.graphic(o, chapter);
      };

      chapter.text = function (textCont, o, style_o) {
        return _this7.text(textCont, o, style_o, chapter);
      };

      chapter.chapter = function (o) {
        return _this7.chapter(o, chapter);
      };
    }
  }, {
    key: "_setProps",
